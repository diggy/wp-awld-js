...
function wp_awld_js_settings_examples_page()
{
	...
	$examples = array(
		array(
			...
			'code' => '[awld type=&#34;person&#34; href=&#34;http://en.wikipedia.org/wiki/Achilles&#34;]Achilles[/awld]',
		...
		array(
			...
			'code' => '[awld href=&#34;http://pleiades.stoa.org/places/550595&#34;]Troy[/awld]',
			'notes' => '',		
		),
		array(
			'id' => 'perseus',
			...
			'code' => '[awld href=&#34;http://data.perseus.org/citations/urn:cts:greekLang:tlg0012.tlg001.perseus-eng1&#34;]beginning[/awld]',
		...
		array(
			...
			'code' => '[awld href=&#34;http://pleiades.stoa.org/places/433032&#34;]Pompeii[/awld]',
			'notes' => 'Format links to the Pelagios project',
		),
		array(
			'id' => 'ukpas',
			'title' => array( 'UK Portable Antiquities Scheme', 'finds.org.uk', 'http://finds.org.uk/' ),
			...
			'code' => '[awld href=&#34;http://finds.org.uk/database/artefacts/record/id/495315&#34;]Aureus[/awld]',
		...
		array(
			...
			'code' => '&lt;sup&gt;[awld href=&#34;http://lccn.loc.gov/a55003923&#34;]loc link[/awld]&lt;/sup&gt;',
		...
		array(
			...
			'code' => '&lt;sup&gt;[awld href=&#34;http://www.worldcat.org/oclc/84948065&#34;]worldcat link[/awld]&lt;/sup&gt;',
		...
		array(
			...
			'code' => '[awld href=&#34;http://nomisma.org/id/athens&#34;]Athens[/awld]',
			//'code' => '[awld href=&#34;http://nomisma.org/id/rrc-525.4a&#34;]RRC 525/4a[/awld]',
		...
		array(
			...
			'code' => '[awld type=&#34;object&#34; href=&#34;http://opencontext.org/subjects/73221A18-7A7C-44C4-36CD-0CECF8F7A725&#34;]This sherd published by OpenContext.org[/awld]',
		...
		array(
			...
			'code' => '[awld href=&#34;http://arachne.uni-koeln.de/item/objekt/1460&#34;]small ships[/awld]',
			'notes' => '',
		),
		array(
			'id' => 'trismegistos',
			...
			'code' => '[awld href=&#34;http://www.trismegistos.org/text/13&#34;]text[/awld]',
		...
		array(
			...
			'code' => '[awld href=&#34;http://www.papyri.info/hgv/1357&#34;]Papyri.info[/awld]',
			'notes' => 'Displays more information about the cited text.',
		),
		array(
			'id' => 'eol',
			...
			'code' => '[awld href=&#34;http://eol.org/pages/328699&#34;]Cow[/awld]',
			'notes' => '',
		),
		array(
			'id' => 'yale',
			...
			'code' => '[awld href=&#34;http://ecatalogue.art.yale.edu/detail.htm?objectId=139601&#34;]Posthumous Alexander[/awld]',
			'notes' => '',
		),
		array(
			'id' => 'wikipedia-fr',
			...
			'code' => '[awld class=&#34;noise&#34; type=&#34;person&#34; href=&#34;http://fr.wikipedia.org/wiki/Alexandre_le_Grand&#34;]Alexander the Great[/awld]',
		...
		<?php
			foreach( $examples as $example ) : 
				$return = '<tr id="' . $example['id'] . '" valign="top">
					<td>
						<p class="awld-link"><a href="' . $example['title'][2] . '" target="_blank">' . $example['title'][0] . '</a></p>
						<p class="description">' . $example['title'][1] . '</p>
					</td>
					<td>
						<p id="' . $example['id'] . '">' . $example['example'] . '</p>
					</td>
					<td>
						<input type="text" onclick="jQuery(this).select();" value="' . $example['code'] . '" />
					</td>
					<td>
						<p class="description">' . $example['notes'] . '</p>
					</td>
				</tr>';
				echo $return;
			endforeach;
